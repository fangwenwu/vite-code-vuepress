import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.df6491c0.js";const q=JSON.parse('{"title":"进阶用法","description":"","frontmatter":{},"headers":[],"relativePath":"componentDocs/upgrade/Component.md","filePath":"componentDocs/upgrade/Component.md"}'),p={name:"componentDocs/upgrade/Component.md"},o=l(`<h1 id="进阶用法" tabindex="-1">进阶用法 <a class="header-anchor" href="#进阶用法" aria-label="Permalink to &quot;进阶用法&quot;">​</a></h1><h2 id="介绍" tabindex="-1">介绍 <a class="header-anchor" href="#介绍" aria-label="Permalink to &quot;介绍&quot;">​</a></h2><p>通过本章节你可以了解到，组件的json结构、vue结构、useBaseHook函数等。</p><h2 id="组件json结构" tabindex="-1">组件json结构 <a class="header-anchor" href="#组件json结构" aria-label="Permalink to &quot;组件json结构&quot;">​</a></h2><p>组件json结构是组件的配置信息，通过json结构可以配置组件的属性、事件、样式、数据、子组件等，json结构的配置项和组件的属性一一对应，现在以Button组件为例，具体如下：</p><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">{</span></span>
