import{_ as s,o as n,c as a,Q as p}from"./chunks/framework.221f7e9b.js";const C=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"componentDocs/upgrade/ComponentGroup.md","filePath":"componentDocs/upgrade/ComponentGroup.md"}'),l={name:"componentDocs/upgrade/ComponentGroup.md"},o=p(`<h2 id="介绍" tabindex="-1">介绍 <a class="header-anchor" href="#介绍" aria-label="Permalink to &quot;介绍&quot;">​</a></h2><p>组合组件，意思是多个组件组合成一个组件，这个组件的属性由子组件的属性需求自定义。</p><h2 id="示例" tabindex="-1">示例 <a class="header-anchor" href="#示例" aria-label="Permalink to &quot;示例&quot;">​</a></h2><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">&lt;!-- 搜索组件 --&gt;</span></span>
