...
<span class="line"><span style="color:#24292E;">&lt;/</span><span style="color:#22863A;">template</span><span style="color:#24292E;">&gt;</span></span></code></pre></div><h2 id="使用组件" tabindex="-1">使用组件 <a class="header-anchor" href="#使用组件" aria-label="Permalink to &quot;使用组件&quot;">​</a></h2><p>创建一个 ATemplate文件夹，文件夹中创建ATemplate.vue，ATemplate.js，ATemplate.json文件，引入BasePage，BaseButton组件。更多请参考 <a href="/vite-code-vuepress/componentDocs/upgrade/Component.html">组件介绍</a></p><p>效果:</p>`,13),i=l(`<ol><li>ATemplate.vue 固定的页面格式</li></ol><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">script</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">setup</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">name</span><span style="color:#E1E4E8;">=</span><span style="color:#9ECBFF;">&quot;ATemplate&quot;</span><span style="color:#E1E4E8;">&gt;</span></span>
...
<span class="line"><span style="color:#24292E;">  }</span></span>
<span class="line"></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div><ol start="3"><li>ATemplate.json 固定的json结构 更多请参考 <a href="/vite-code-vuepress/componentDocs/upgrade/Component.html">组件介绍</a></li></ol><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">{</span></span>
...
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">  ]</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div>`,6),d=JSON.parse('{"title":"快速上手","description":"","frontmatter":{},"headers":[],"relativePath":"componentDocs/Install.md","filePath":"componentDocs/Install.md"}'),F={name:"componentDocs/Install.md"},B=Object.assign(F,{setup(u){const s=p(null);return o(()=>{e(()=>import("./chunks/ATemplate.48b8030f.js"),["assets/chunks/ATemplate.48b8030f.js","assets/chunks/vite-code.d0ec0b8c.js","assets/chunks/pinia.50154b9a.js","assets/chunks/framework.221f7e9b.js"]).then(n=>{s.value=n.default})}),(n,C)=>(a(),t("div",null,[y,s.value?(a(),c(r(s),{key:0})):E("",!0),i]))}});export{d as __pageData,B as default};
